...
public class TradingTableInitMenu extends AbstractContainerMenu {
    ...
    public TradingTableInitMenu(int containerId, @NotNull Inventory playerInventory) {
        this(containerId, playerInventory, new ItemStacksResourceHandler(TradingTableBlockEntity.INVENTORY_SIZE), ContainerLevelAccess.NULL);
    }

    public TradingTableInitMenu(int containerId, @NotNull Inventory playerInventory,
                                @NotNull ItemStacksResourceHandler inventory, @NotNull ContainerLevelAccess access) {
