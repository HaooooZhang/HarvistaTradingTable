...
public final class TTBlocks {
    ...
    public static final DeferredBlock<BlockTradingTable> TRADING_TABLE = BLOCKS.registerBlock(
            "trading_table",
            BlockTradingTable::new,
    ...
    public static final DeferredBlock<BlockSystemTradingTable> SYSTEM_TRADING_TABLE = BLOCKS.registerBlock(
